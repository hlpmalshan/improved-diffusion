...
# NUM_SAMPLES=27000            # number of images to generate
# BATCH_SIZE_SAMPLE=75  # batch size per sampling step (adjust if memory is tight)
# ATTN_RES="32,16,8"

# # Model/diffusion flags matching training
# MODEL_FLAGS="--image_size 256 --num_channels 192 --num_res_blocks 3 --attention_resolutions $ATTN_RES --dropout 0.3 --learn_sigma True"
