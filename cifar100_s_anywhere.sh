...
CKPTS["0.0"]="/data/diffusion/repos/improved-diffusion/logs_improved_diffusion_cifar100/cifar100_reg0.0/ema_0.9999_076245.pt"
CKPTS["0.3"]="/data/diffusion/repos/improved-diffusion/logs_improved_diffusion_cifar100/cifar100_reg0.3/ema_0.9999_076245.pt"
...
for REG in 0.3; do
    ...
    echo "==== [Sampling][CIFAR100] reg_val=${REG} ===="
